...
class RutasGuardadasController {
  ...
  Future init(BuildContext context, refresh) async {
    ...
    getRutasGuardadasList();
  }

  void getRutasGuardadasList() async {
    rutasGuardadasList = (await _travelHistoryProvider.getUserSavedRoutes())!;
    datosCargados = true;
    refresh();
  }
